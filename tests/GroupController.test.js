...
describe('create', () => {
    testUtil.shouldExist(GroupController.create);
    testUtil.shouldBeAFunction(GroupController.create);
...
describe('changeTitle', () => {
    testUtil.shouldExist(GroupController.changeTitle);
    testUtil.shouldBeAFunction(GroupController.changeTitle);
...
describe('changeDesc', () => {
    testUtil.shouldExist(GroupController.changeDesc);
    testUtil.shouldBeAFunction(GroupController.changeDesc);
...
describe('getMyGroupsInfo', () => {
    testUtil.shouldExist(GroupController.getMyGroupsInfo);
    testUtil.shouldBeAFunction(GroupController.getMyGroupsInfo);
...
describe('getInfo', () => {
    testUtil.shouldExist(GroupController.getInfo);
    testUtil.shouldBeAFunction(GroupController.getInfo);
    ...
    test('should fail on error', async () => {
        // Mocks
        GroupInfo.getGroupsInfo = jest.fn().mockImplementation(() => {
            throw new Error('');
        });
        expect.assertions(1);
        try {
...
describe('getPolls', () => {
    testUtil.shouldExist(GroupController.getPolls);
    testUtil.shouldBeAFunction(GroupController.getPolls);
    ...
    test('should fail on error', async () => {
        // Mocks
        GroupUsers.isMember = jest.fn().mockImplementation(() => {
            throw new Error('');
        });
        GroupPolls.getPolls = jest.fn();
        expect.assertions(2);
