...
describe('addUser', () => {
    test('should exist', () => {
        // Expects
        expect(GroupUserController.addUser).toBeDefined();
    });

    test('should be a function', () => {
        // Expects
        expect(typeof GroupUserController.addUser).toBe('function');
    });
    ...
    test('should fail for invalid userid', async () => {
        ...
        try {
            ...
            // Tests
            await GroupUserController.addUser(userid,
                useridsToAdd, groupid, permission);
        } catch (err) {
            // Expects
    ...
    test('should fail for invalid permission', async () => {
        ...
        try {
            ...
            // Expects
            expect(err.message)
                .toEqual('argument \'permission\' must be a nonEmptyString');
        }
    });
    ...
    test('should pass - adding all users', async () => {
        ...
        expect(ControllerHelper.informGroupUserUpdate)
            .toHaveBeenCalledWith(groupid, JSON.stringify(redisData));
    });
...
describe('changeUserPermission', () => {
    test('should exist', () => {
        // Expects
        expect(GroupUserController.changeUserPermission).toBeDefined();
    });

    test('should be a function', () => {
        // Expects
        expect(typeof GroupUserController.changeUserPermission).toBe('function');
    });
    ...
    test('should fail for invalid userid', async () => {
        ...
        try {
            ...
            const permission = 'USER';
            // Tests
            await GroupUserController.changeUserPermission(userid,
                useridToUpdate, groupid, permission);
        } catch (err) {
            // Expects
            expect(err.message).toEqual('argument \'userid\' must be a number');
        }
    ...
    test('should pass', async () => {
        ...
        const permission = 'ADMIN';
        // Tests
        const reply = await GroupUserController.changeUserPermission(userid,
            useridToUpdate, groupid, permission);
...
describe('removeUser', () => {
    test('should exist', () => {
        // Expects
        expect(GroupUserController.removeUser).toBeDefined();
    });

    test('should be a function', () => {
        // Expects
        expect(typeof GroupUserController.removeUser).toBe('function');
    });
    ...
    test('should pass', async () => {
        ...
        const groupid = 3010;
        // Tests
        const reply = await GroupUserController.removeUser(userid,
            useridToRemove, groupid);
        const expectedResult = {
...
describe('getUsersOfGroup', () => {
    test('should exist', () => {
        // Expects
        expect(GroupUserController.getUsersOfGroup).toBeDefined();
    });

    test('should be a function', () => {
        // Expects
        expect(typeof GroupUserController.getUsersOfGroup).toBe('function');
    });
