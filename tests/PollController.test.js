...
describe('create', () => {
    test('should exist', () => {
        // Expects
        expect(PollController.create).toBeDefined();
    });

    test('should be a function', () => {
        // Expects
        expect(typeof PollController.create).toBe('function');
    });
});
...
describe('vote', () => {
    test('should exist', () => {
        // Expects
        expect(PollController.vote).toBeDefined();
    });

    test('should be a function', () => {
        // Expects
        expect(typeof PollController.vote).toBe('function');
    });
    ...
    test('should pass - OpenVote', async () => {
        ...
        redHelper.getPollResult = jest.fn()
        .mockImplementation(() => pollResult);
        ...
        expect(redHelper.updateOpenVoteResult).toHaveBeenCalledWith(pollid, option);
        expect(redHelper.updateSecretVoteResult).not.toHaveBeenCalled();
        // For frequent access
        expect(redClient.sadd).toHaveBeenCalledWith(keyPrefix.pollVotedUsers + pollid, userid);
    ...
    test('should pass - SecretVote', async () => {
        ...
        expect(PollVoteData.saveVote).toHaveBeenCalledWith(data);
        // For updating results
        expect(redHelper.updateSecretVoteResult).toHaveBeenCalledWith(pollid, option);
        expect(redHelper.updateOpenVoteResult).not.toHaveBeenCalled();
        // For frequent access
        expect(redClient.sadd).toHaveBeenCalledWith(keyPrefix.pollVotedUsers + pollid, userid);
        expect(redClient.sadd).toHaveBeenCalledWith(keyPrefix.pollUpdates, pollid);
        // Transactions
...
describe('getMyPollsInfo', () => {
    test('should exist', () => {
        // Expects
        expect(PollController.getMyPollsInfo).toBeDefined();
    });

    test('should be a function', () => {
        // Expects
        expect(typeof PollController.getMyPollsInfo).toBe('function');
    });
    ...
    test('should pass', async () => {
        ...
        GroupUsers.getGroupsOfUser = jest.fn().mockImplementation(() => [3010, 3011]);
        GroupPolls.getPolls = jest.fn().mockImplementation(() => [{ pollid: 1002 }, { pollid: 1006 }]);
        UserPolls.getPolls = jest.fn().mockImplementation(() => [{ pollid: 1008 }, { pollid: 1006 }]);
        PollData.getPollInfoByPollIds = jest.fn().mockImplementation(() => expectedResult);
        // Data
        const userid = 2004;
        // Tests
...
describe('getInfo', () => {
    test('should exist', () => {
        // Expects
        expect(PollController.getInfo).toBeDefined();
    });

    test('should be a function', () => {
        // Expects
        expect(typeof PollController.getInfo).toBe('function');
    });
    ...
    test('should pass', async () => {
        ...
        PollData.getPollInfoByPollIds = jest.fn()
...
describe('delete', () => {
    test('should exist', () => {
        // Expects
        expect(PollController.delete).toBeDefined();
    });

    test('should be a function', () => {
        // Expects
        expect(typeof PollController.delete).toBe('function');
    });
    ...
    test('should fail if someone casted vote already', async () => {
        ...
        VoteRegister.getVotersList = jest.fn().mockImplementation(() => [2004, 2005]);
        expect.assertions(1);
        try {
            // Data
            const userid = 2004;
